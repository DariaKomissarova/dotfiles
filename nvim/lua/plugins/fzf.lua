return {
  {
    ...
    keys = {
      ...
      { "<leader>fd", require("fzf-lua").lsp_definitions, desc = "Find File" },
      { "<leader>fi", require("fzf-lua").lsp_implementations, desc = "Find File" },
    ...
    config = function()
      ...
      require("fzf-lua").setup({
        height = 0.75,
        fzf_opts = { ["--layout"] = "default", ["--style"] = "full" },
        winopts = { preview = { layout = "horizontal", vertical = "up:70%" } },
